// Generated from the tweakcn Vite theme registry.
// Source: https://tweakcn-picker.vercel.app/r/vite/theme-system.json
...
// Default theme
export const DEFAULT_COLOR_THEME = "book-cook";
...
export const allColorThemeValues = colorThemes.map((theme) => theme.name);
